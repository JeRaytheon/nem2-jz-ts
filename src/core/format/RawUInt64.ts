...
export class RawUInt64 {
    static readonly readUint32At = (bytes: any, i: any) => (bytes[i] + (bytes[i + 1] << 8) + (bytes[i + 2] << 16) + (bytes[i + 3] << 24)) >>> 0;
    ...
    public static fromUint = (number: any) => {
     ...
     * @returns {module:coders/uint64~uint64} The uint64 representation of the input.
     */
    public static fromBytes = (uint8Array: any) => {
     ...
     * @returns {module:coders/uint64~uint64} The uint64 representation of the input.
     */
    public static fromBytes32 = (uint8Array: any) => {
     ...
     * @returns {module:coders/uint64~uint64} The uint64 representation of the input.
     */
    public static fromHex = (input: any) => {
        if (16 !== input.length) {
     ...
     */
    public static toHex = (uint64: any) => {
     ...
     */
    public static isZero = (uint64: any) => 0 === uint64[0] && 0 === uint64[1];
}
