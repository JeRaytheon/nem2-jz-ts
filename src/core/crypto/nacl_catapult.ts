...
const A = (o:any, a:any, b:any) => {
    for (let i = 0; i < 16; i++) {
        o[i] = a[i] + b[i];
    }
};

const Z = (o:any, a:any, b:any) => {
    for (let i = 0; i < 16; i++) {
        o[i] = a[i] - b[i];
    }
};

const M = (o:any, a:any, b:any) => {
    // tslint:disable-next-line:one-variable-per-declaration
    let v, c,
        t0 = 0,
        t1 = 0,
...
const vn = (x:any, xi:any, y:any, yi:any, n:any) => {
    // tslint:disable-next-line:one-variable-per-declaration
    let i, d = 0;
    for (i = 0; i < n; i++) {
        d |= x[xi + i] ^ y[yi + i];
...
const sel25519 = (p:any, q:any, b:any) => {
    // tslint:disable-next-line:one-variable-per-declaration
    let t, c = ~(b - 1);
    for (let i = 0; i < 16; i++) {
        t = c & (p[i] ^ q[i]);
...
export const crypto_shared_key_hash = (shared:any, pk:any, sk:any, hashfunc:any, signSchema:any) => {
...
// tslint:disable-next-line: variable-name
export const crypto_verify_32 = (x:any, xi:any, y:any, yi:any) => {
...
export const scalarmult = (p:any, q:any, s:any) => {
    // tslint:disable-next-line:one-variable-per-declaration
    let b, i;
    set25519(p[0], gf0);
    set25519(p[1], gf1);
...
export const scalarbase = (p:any, s:any) => {
    const q = [gf(), gf(), gf(), gf()];
    set25519(q[0], X);
    set25519(q[1], Y);
    set25519(q[2], gf1);
...
export const unpackneg = (r:any, p:any) => {
    // tslint:disable-next-line:one-variable-per-declaration
    const t = gf(),
        chk = gf(),
        num = gf(),
...
export const unpack = (r:any, p:any) => {
    // tslint:disable-next-line:one-variable-per-declaration
    const t = gf(),
        chk = gf(),
        num = gf(),
