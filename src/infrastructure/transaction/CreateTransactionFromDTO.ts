 ...
 * @constructor
 */
export const CreateTransactionFromDTO = (transactionDTO:any): Transaction => {
    if (transactionDTO.transaction.type === TransactionType.AGGREGATE_COMPLETE ||
        ...
        const innerTransactions = transactionDTO.transaction.transactions.map((innerTransactionDTO:any) => {
        ...
        return new AggregateTransaction(
            ...
            transactionDTO.transaction.cosignatures ? transactionDTO.transaction.cosignatures
                .map((aggregateCosignatureDTO:any) => {
 ...
 * @constructor
 */
const CreateStandaloneTransactionFromDTO = (transactionDTO:any, transactionInfo:any): Transaction => {
    ...
    if (transactionDTO.type === TransactionType.TRANSFER) {
        ...
        return new ModifyMultisigAccountTransaction(
            ...
            transactionDTO.modifications ? transactionDTO.modifications.map((modificationDTO:any) => new MultisigCosignatoryModification(
        ...
        return new AccountAddressRestrictionModificationTransaction(
            ...
            transactionDTO.modifications ? transactionDTO.modifications.map((modificationDTO:any) => new AccountRestrictionModification(
                modificationDTO.type,
...
export const extractMosaics = (mosaics: any): Mosaic[] => {
    ...
    return mosaics.map((mosaicDTO:any) => {
